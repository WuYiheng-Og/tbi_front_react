...
let patients = [
  ...
  { id: "P002", name: "李四", age: 32, sex: "女", address: "上海市浦东新区", phone: "13900139000", remark: "" },
  { id: "P003", name: "王五", age: 58, sex: "男", address: "广州市天河区", phone: "13700137000", remark: "糖尿病" },
];
...
export async function GET(request: NextRequest) {
  ...
  const filtered = patients.filter((p) => {
    ...
    return matchPatientId && matchName && matchAge && matchSex && matchAddress && matchPhone && matchRemark;
  });
