...
## 项目演示
本视频展示 TBI 系统核心功能的完整操作流程（录制时间：2026-03-17）：

### 在线播放

<video  src="./docs//TBI-demo_2026-03-17.mp4"   controls  width="640"  style="max-width: 100%; border-radius: 8px; box-shadow: 0 2px 12px rgba(0, 0, 0, 0.1);" >
  您的浏览器不支持 HTML5 视频播放，请点击下方链接下载视频查看。
</video>

### 备用方式
若在线播放异常，可点击链接下载视频：  
[📥 下载项目演示视频](./TBI-demo_2026-03-17.mp4)
...
| state | msg                    | 说明                       |
| ----- | ---------------------- | -------------------------- |
| 0     | 文件出错/脑氧文件出错等    | 数据处理失败，显示错误提示      |
| 1     | 文件合并成功！           | 数据处理成功，显示成功提示      |

停止采集后，前端会显示模态框提示处理结果：
- **成功**：显示绿色成功图标和"数据处理完成"提示，关闭后可进行预测分析
- **失败**：显示红色错误图标和具体错误信息，提供"重新监测"和"关闭"按钮
